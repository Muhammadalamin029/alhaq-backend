...
def send_welcome_email(self, user_email: str, user_name: str):
    ...
    """
    try:
        # Central template: shares the _base_html/_base_text shell with every
        # other email so a single restyle applies here too.
        html_body, text_body = email_service.render_welcome_email(user_name)
