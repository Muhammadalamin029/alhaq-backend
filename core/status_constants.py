...
FINANCING_APPLICATION_STATUS_PENDING_REVIEW: Final[str] = "pending_review"
FINANCING_APPLICATION_STATUS_APPROVED: Final[str] = "approved"
FINANCING_APPLICATION_STATUS_REJECTED: Final[str] = "rejected"
FINANCING_APPLICATION_STATUS_REVOKED: Final[str] = "revoked"

FINANCING_APPLICATION_STATUSES: Final[tuple[str, ...]] = (
...
FINANCING_APPLICATION_TERMINAL_STATUSES: Final[tuple[str, ...]] = (
    FINANCING_APPLICATION_STATUS_REJECTED,
    FINANCING_APPLICATION_STATUS_REVOKED,
)
